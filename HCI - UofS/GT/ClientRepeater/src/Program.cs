...
namespace GT.Net
{
    ...
    public class ClientRepeater : IStartable
    {
        ...
        #region StartSeparateListeningThread
        /// <summary>
        ...
        #region _client_TransportRemoved
