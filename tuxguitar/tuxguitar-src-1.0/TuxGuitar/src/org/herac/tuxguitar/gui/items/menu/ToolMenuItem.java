...
import org.herac.tuxguitar.gui.actions.tools.CollabAction;
...
public class ToolMenuItem implements MenuItems {
	...
	public void showItems(){
		...
		this.collab = new MenuItem(this.menu, SWT.PUSH);
		this.collab.addSelectionListener(TuxGuitar.instance().getAction(CollabAction.NAME));
	...
	public void loadProperties(){
		...
		this.collab.setText(TuxGuitar.getProperty("tools.collab"));
