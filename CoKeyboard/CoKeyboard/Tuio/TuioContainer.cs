...
public abstract class TuioContainer:TuioPoint {
	...
	public static readonly int TUIO_ADDED = 0;
	public static readonly int TUIO_UPDATED = 1;
	public static readonly int TUIO_REMOVED = 2;
	...
	new public void setUpdateTime(long timestamp) {
